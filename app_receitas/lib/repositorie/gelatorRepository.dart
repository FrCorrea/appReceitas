...
import 'package:app_receitas/repositorie/IngredientsGelatorRepository.dart';
import 'package:app_receitas/repositorie/recipesRepository.dart';
...
class GelatorRepository extends ChangeNotifier{
  ...
  insertGelator(Gelator gelator) async{
    ...
    for(int i = 0; i< gelator.ingredients.length; i++){
      ingredientsGelator.insertIngredientsGelator(gelator.ingredients[i], idGelator);
    }
    notifyListeners();
  }
}